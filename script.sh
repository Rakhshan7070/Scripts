...
device_soc="sm7325"        # Example: sm7325
...
repos=(
    "$DT_DIR https://github.com/crdroidandroid/android_device_motorola_dubai 15.0"
    "$CDT_DIR https://github.com/crdroidandroid/android_device_motorola_sm7325-common 15.0"
    "$KERNEL_DIR https://github.com/crdroidandroid/android_kernel_motorola_sm7325 15.0"
    "$VENDOR_DIR https://gitlab.com/crdroidandroid/proprietary_vendor_motorola_dubai 15.0"
    "$COMMON_VENDOR_DIR https://github.com/crdroidandroid/proprietary_vendor_motorola_sm7325-common 15.0"
    "$HARDWARE_MOTOROLA_DIR https://github.com/crdroidandroid/android_hardware_motorola 15.0-V2"
)
...
export BUILD_USERNAME=Rakhshan7070
